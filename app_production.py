...
def generate_audio(script, session_id):
    ...
    try:
        update_progress(session_id, "Audio generation temporarily disabled in demo", 40)
        update_progress(session_id, "Transcript generated successfully!", 100)
        return None, None
...
def process_meditation_request(scenario, duration, generate_audio_flag, session_id):
    ...
    try:
        ...
        with open(transcript_path, 'w', encoding='utf-8') as f:
            f.write(f"Hemi-gen Meditation Transcript\n")
            f.write(f"{'='*50}\n")
...
if __name__ == '__main__':
    ...
    # Production server would use gunicorn instead
